...
export class CertificateClient {
   ...
   */
  public deploy(params: CertificateDeployArgs & AppClientDeployCoreParams = {}): ReturnType<ApplicationClient['deploy']> {
  ...
  public hello(args: MethodArgs<'hello(string)string'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
    return this.call(CertificateCallFactory.hello(args, params))
  }
...
export type CertificateComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  hello(args: MethodArgs<'hello(string)string'>, params?: AppClientCallCoreParams & CoreAppCallArgs): CertificateComposer<[...TReturns, MethodReturn<'hello(string)string'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  clearState(args?: BareCallArgs & AppClientCallCoreParams & CoreAppCallArgs): CertificateComposer<[...TReturns, undefined]>
   ...
   */
  simulate(): Promise<CertificateComposerSimulateResult>
  /**
   * Executes the transaction group and returns the results
   */
  execute(): Promise<CertificateComposerResults<TReturns>>
}
export type CertificateComposerSimulateResult = {
